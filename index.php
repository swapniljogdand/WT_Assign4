<!DOCTYPE html>
    <head>
        <title>Sahyadri Family Resturent</title>
        <!-- CSS only -->
    ...
    <body>
        <div class=" jumbotron text-center"><h1 style="color: white;">Sahyadri Family Resturent </h1></div>
       
        <div class="cont">
            <h1>Select The Menu Item To See Its Detail</h1>
          </div>
        ...
        <footer>
            <!-- <div class="footer1">
                <div class="container-fluid"> -->
                    ...
                    <a href="mailto:smjagdand@mitaoe.ac.in">smjagdand@mitaoe.ac.in</a></p>
                    <!-- </div>
              </div> -->
        </footer>
